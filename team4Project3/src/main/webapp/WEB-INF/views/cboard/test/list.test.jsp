	...
	<div class="container">
		<div class="row">
			<table class="table table-bordered margin-space" style="text-align: center; border: 1px solid #dddddd">
				<tbody>
					<tr>
						...
						<th width="130" class="text-center">업체명</th>
						...
						<th width="140" class="text-center">평수</th>
						<th width="140" class="text-center">기간</th>
						<!-- <th width="140" class="text-center">수정일</th> -->
						<th width="60" class="text-center">좋아요</th>
					</tr>
					...
					<c:forEach var="cboard" items="${list}">
						<tr>
							<td>${cboard.cbno}</td>
							<td>${cboard.companyName}</td>
							<td>${cboard.cnstType}</td>
							<td><a
								href="read?cbno=${cboard.cbno}">
			...
			<div class="margin-space" style="text-align: right">
				<a href="write" class="btn btn-primary ">게시글 작성</a>
			</div>
