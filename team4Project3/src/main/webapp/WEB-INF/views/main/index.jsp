                        ...
                        <div class="col-md-5 col-sm-6 col-xs-12">
                            <div  class="welcome_services wow fadeInRight" data-wow-delay="0.3s" data-wow-offset="100">
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 m-padding">
                                        <div class="welcome-estate">
                                        <a class="WriteBoard__main__icon" href="${pageContext.request.contextPath}/board/write.do">
                                            <div class="welcome-icon" >
                                                <i class="pe-7s-users pe-4x">
                                                </i>
                                            </div>
                                            </a>
                                            <h3>견적신청</h3>
                                    ...
                                    <div class="col-xs-6 m-padding">
                                        <div class="welcome-estate">
                                        <a class="WriteBoard__main__icon" href="${pageContext.request.contextPath}/info/QNA.do">
                                            <div class="welcome-icon">
